...
class Dataset(Dataset):
    def __init__(self, transform=None, train=True):
        ...
        # Using a 80/20 split
        if train:
            self.all_files = self.all_files[::1830]
            self.labels = self.labels[::1830]
...
class CNN(nn.Module):
    def __init__(self, out_1, out_2, out_3):
        ...
        self.maxpool1=nn.MaxPool2d(kernel_size=4) # Max pooling layer, output is 40
        self.cnn2 = nn.Conv2d(in_channels=out_1, out_channels=out_2, kernel_size=5, padding=2) # Output is 40
        self.maxpool2 = nn.MaxPool2d(kernel_size=2) # Output is 20
        ...
        self.fc1 = nn.Linear(10*10*out_3, 26) # Fully connected neural network
...
print("Num correct: ", train_model(15))
